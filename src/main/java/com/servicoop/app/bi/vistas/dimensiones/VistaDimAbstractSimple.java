...
import main.java.com.servicoop.app.bi.controles.servicios.mediciones.ServMedPromedio;
import main.java.com.servicoop.app.bi.controles.servicios.mediciones.ServMedTotal;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoAbstract;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoAnio;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoMes;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoQuincena;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoSemestre;
import main.java.com.servicoop.app.bi.controles.servicios.periodos.ServPeriodoTrimestre;
...
import main.java.com.servicoop.app.bi.graficas.GraficoBarras;
import main.java.com.servicoop.app.bi.graficas.GraficoLineas;
import main.java.com.servicoop.app.bi.graficas.GraficoTorta;
import main.java.com.servicoop.app.bi.vistas.consultas.TableModelMedicionTemporal;
import main.java.com.servicoop.app.bi.vistas.eventos.EventoConfigurable;
import main.java.com.servicoop.app.bi.vistas.eventos.EventoDim;
 ...
 *
 * LO QUE HAGO construyo un marco sobre el cual se almacenaran los componentes
 * del segundo nivel de evaluacion.
 *
 * LO QUE CONOZCO
 *
 * ==== parte colaboracion ==================
 ...
 *
 * COMO INTERACTUO CON MI COLABORADOR, entregando el marco de desarrollo segun
 * el evento que corresponda.
 *
 */
public abstract class VistaDimAbstractSimple extends JPanel
	...
	private JCheckBox chckbxContarPeriodosNulos;
	...
	public VistaDimAbstractSimple(ServDimAbstract serv_dim_vista_seleccionada, List<Alarma> consultas) {
		...
		try {
			...
			intervalo.setUltima_alarma(Collections.max(consulta).getFecha_inicio());
												 ...
												 * util para que no reviente con windowsBuilder
												 */
		}
	...
	public void configEventos(EventoDim eventos) {
		...
		chckbxContarPeriodosNulos.addActionListener(eventos);
	}
	...
	public void ejecutarDimension() {
		...
		datos_tabla = serv_dim_vista_seleccionada.completarTabla(serv_medicion, serv_periodo,
				chckbxContarPeriodosNulos.isSelected());
	...
	public JCheckBox getChckbxContarPeriodosNulos() {
		return chckbxContarPeriodosNulos;
	}
	...
	/**
	 * atraves de la vista se entrega el contenido de toda la tabla, propiedad del
	 * modelo de la tabla, que debe ser casteado al tipo exclusivo creado para este
	 * dato, al que se le agrego un metodo adicional para devolver su contenido.
	 *
	 * @return
	 */
	...
	public void iniciarComponentes() {
		...
		chckbxContarPeriodosNulos = new JCheckBox("Contar periodos nulos");
		...
		gl_pl_tiempo.setHorizontalGroup(gl_pl_tiempo.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pl_tiempo.createSequentialGroup().addContainerGap().addComponent(lbl_medicion)
						...
						.addComponent(chckbxContarPeriodosNulos).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(btnEjecutar).addContainerGap()));
		gl_pl_tiempo.setVerticalGroup(gl_pl_tiempo.createParallelGroup(Alignment.LEADING).addGroup(gl_pl_tiempo
				.createSequentialGroup()
				.addGroup(gl_pl_tiempo.createParallelGroup(Alignment.LEADING).addGroup(gl_pl_tiempo
						.createSequentialGroup().addContainerGap()
						.addGroup(gl_pl_tiempo.createParallelGroup(Alignment.BASELINE)
								.addComponent(cbox_medicion, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lbl_medicion).addComponent(btnEjecutar)
								.addComponent(chckbxContarPeriodosNulos)))
