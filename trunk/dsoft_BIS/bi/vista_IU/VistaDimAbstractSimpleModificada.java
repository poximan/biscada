...
public abstract class VistaDimAbstractSimpleModificada extends JPanel implements PanelIniciable, EventoConfigurable,
		DimensionCalculable {
	...
	public VistaDimAbstractSimpleModificada(ServDimAbstract serv_dim_vista_seleccionada, List<Alarma> consultas) {
	 ...
	 */
	public VistaDimAbstractSimpleModificada(ServDimAbstract serv_dim_vista_seleccionada, ServDimSitio serv_dim_sitio,
