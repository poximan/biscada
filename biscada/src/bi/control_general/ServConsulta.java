...
public class ServConsulta implements ObjetosBorrables {
	 ...
	 * 
	 * si el usuario habilit� la opcion de filtrar las alarmas por tiempo minimo de vida, para descartar de esta manera
	 * alarmas que duren menos que un periodo de tiempo indicado en segundos, este metodo ser� ejecutado.
	 * 
	 * @param criteria
	 * 
	 * @param fecha_inicio
	 ...
	 * creador de parametro dinamico.
	 * 
	 * si el usuario habilit� la opcion de filtrar las alarmas por tiempo maximo de vida, para descartar de esta manera
	 * alarmas que duren mas que un periodo de tiempo indicado en segundos, este metodo ser� ejecutado.
	 * 
	 * @param criteria
	 * 
	 * @param fecha_inicio
	 ...
	 * creador de parametro dinamico.
	 * 
	 * si el usuario especific� una "fecha desde" en particular, se traeran solo alarmas con fecha >= para el campo
	 ...
	 * creador de parametro dinamico.
	 * 
	 * si el usuario especific� una "fecha hasta" en particular, se traeran solo alarmas con fecha <= para el campo
	 * especificado [fecha inicio, ack, fin]
	 * 
	 * @param criteria
	 * 
