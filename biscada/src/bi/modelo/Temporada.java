...
public abstract class Temporada {
	 ...
	 * implementada la logica, la comparacion de fecha inicio se hace por una fecha cuyo a�o adelantado una unidad, por
	 ...
	 * 
	 * @return segun el contexto podr�a ser 1 para el verano, y 0 para el resto de las temporadas
	 * 
	 */
