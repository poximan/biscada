...
public interface DimensionCalculable {
	 ...
	 * "Segundo nivel de evaluaci�n � Dimensiones",
	 * "Tercer nivel de evaluaci�n - Mediciones") puede solicitar que se
	 * procese la informacion. esta interfaz brinda la forma normalizada de
