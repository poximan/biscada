...
public class AltaTemperaturaBobinado extends Suceso {
	...
	public static void asociar(TipoDatoFabricable valor, String discriminante) throws CampoTextoAmbiguoExcepcion {
		...
		if (discriminante.matches(
				Constantes.ABRE_EXP_REG + AltaTemperaturaBobinado.getExpresion_regular() + Constantes.CIERRA_EXP_REG)) {

			if (valor != null)
				throw new CampoTextoAmbiguoExcepcion(
						discriminante + " [ " + AltaTemperaturaBobinado.class.getSimpleName() + " - "
