...
import main.java.com.servicoop.app.bi.controles.ServConsultaDinamica;
import main.java.com.servicoop.app.bi.controles.ServConsultaEstatica;
import main.java.com.servicoop.app.bi.vistas.eventos.EventoComponenteConsulta;
...
public class ComponenteConsulta extends JPanel implements PanelIniciable, EventoConfigurable, EventoManejable {
	...
	public void configBinding() {
		...
		/*
		 * obligatorio dejarlo asi!, cuando el origen de los datos es ilegible (cosa que
		 * sucede cuando no se ha elegido un master) no es posible definir un detalle
		 */
