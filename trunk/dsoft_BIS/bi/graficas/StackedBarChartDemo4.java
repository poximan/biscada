...
/**
 * A simple demonstration application showing how to create a stacked bar chart using data from a
...
public class StackedBarChartDemo4 extends ApplicationFrame {
	...
	/**
	 * Creates the legend items for the chart. In this case, we set them manually because we only want legend items for
	 * a subset of the data series.
	 * 
