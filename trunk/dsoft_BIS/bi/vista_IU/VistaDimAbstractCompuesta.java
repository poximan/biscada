...
public abstract class VistaDimAbstractCompuesta extends JPanel implements
	...
	public void armarSolapasGraficas() {
		...
		graficoComparable graficoDeComparacion = new graficoComparable(
				datos_tabla_interes, encabezado_tabla_interes,
				tbl_filas_interes);

		System.out.println("que le paso a grafico"
				+ tbl_filas_comparador.getRowCount());

		graficoDeComparacion.datosParaComparar(datos_tabla_comparador,
				encabezado_tabla_comparador, tbl_filas_comparador);

		JPanel scroll_grafico = graficoDeComparacion.createDemoPanel();
