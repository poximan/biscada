...
public class GraficoHistorial extends JPanel {
	...
	private static JFreeChart createChart(XYDataset xydataset) {
		JFreeChart jfreechart = ChartFactory.createXYLineChart(null,
				"X", "Cantidad", xydataset, PlotOrientation.VERTICAL, false,
				true, false);
		...
		PeriodAxis periodaxis = new PeriodAxis(null, new Hour(0, 30, 6, 2005),
		...
		aperiodaxislabelinfo[1] = new PeriodAxisLabelInfo(
				org.jfree.data.time.Day.class, new SimpleDateFormat("dd-MMM"));
		...
		ValueMarker valuemarker1 = new ValueMarker(d, Color.blue,
				new BasicStroke(2.0F));
		ValueMarker valuemarker2 = new ValueMarker(d1, Color.blue,
				new BasicStroke(2.0F));
