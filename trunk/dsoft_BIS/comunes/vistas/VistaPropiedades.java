...
public class VistaPropiedades extends JPanel {
	...
	public VistaPropiedades() {
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Valores actuales", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addComponent(panelBtnConfirmar, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
						.addComponent(panelPropiedades, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 316, Short.MAX_VALUE))
					.addContainerGap())
		);
